...
export_mono <- function(output_mono, tree_name) {
  if (is.null(output_mono)) {
    # If output_mono is NULL, create an empty Excel file
    ...
    file_name <- paste("C:/Users/mdrmi/OneDrive/Escritorio/info_about_mono_2/", tree_name, "_monophyletic_info.xlsx", sep = "")
