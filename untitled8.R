...
traits <-  read.xlsx(paste("C:/Users/mdrmi/OneDrive/Escritorio/checked_traits_trees/trait_", list_trees_island[[2]],  ".xlsx", sep=""),1)


tree2 <- read.nexus("Fregilupus.tre")
...
#for (i in available_trees){
  ...
  traits<-  read.xlsx(paste("C:/Users/mdrmi/OneDrive/Escritorio/checked_traits_trees/trait_", i,  ".xlsx", sep=""),1)
  ...
  info_tree <- subset(info_island, syno == available_trees[[1]])
